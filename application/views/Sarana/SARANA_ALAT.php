    ...
    <section id="content">
        <div class="container">
            <div class="section-title">            
                <div class="wrapper">
                    <h2>SARANA ALAT RUANGAN PONDOK PESANTREN </h2>
                </div>           
            </div>       
            <div class="main-title">
                <h5>DATA SARANA ALAT RUANGAN PONDOK PESANTREN </h5>
            </div>
            <div class="row">
                <div class="col-md-8">
                    <div id="tabs" class="div">
                        <ul>
                            <li class=""><a href="#tab-1">R. KELAS</a></li>
                            <li class=""><a href="#tab-2">R. KANTOR GURU</a></li>
                            <li class=""><a href="#tab-3">R. KANTOR TU</a></li>
                            <li class=""><a href="#tab-4">R. PERPUS</a></li>
                        </ul>
                        <ul>
                            <li class=""><a href="#tab-5">R. LAB KOM</a></li>
                            <li class=""><a href="#tab-6">R. LAB IPA/IPS</a></li>
                            <li class=""><a href="#tab-7">TOILET</a></li>
                            <li class=""><a href="#tab-8">WC</a></li>
                        </ul>
                        
                        <!-- SMA -->
                        <div id="tab-1" class="div" style="display: block;">					  
                            <table class="table_noborder" width="100%" rules="all">			       
                                <tbody><tr>
                                    <td width="115">NSS</td>
                                    <td width="10">:</td>
