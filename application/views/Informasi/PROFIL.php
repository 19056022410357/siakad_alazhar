    ...
    <section id="content">
        <div class="container">
            <div class="section-title">            
                <div class="wrapper">
                    <h2>PROFIL YAYASAN DAN PROFIL SEKOLAH </h2>
                </div>           
            </div>       
            <div class="main-title">
                <h5>DATA PROFIL YAYASAN DARUSSALAM BEHJI DAN SEKOLAH</h5>
            </div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div style="position:absolute;margin: 125px 0 0 200px;width:220px;height:220px" class="bingkai"><img src="../foto/logo/1546559737_Logo SMP Yayasan New.png" width="220" height="220"></div>
                </div>
            </div>
        </div>
    </section>
